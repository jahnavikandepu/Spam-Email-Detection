    ...
    <div className="max-w-5xl mx-auto px-4 py-12 animate-fade-in">
      ...
      <section className="text-center mb-12">
        <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight mb-3">
          About <span className="gradient-text">SpamGuard</span>
        </h1>
        <p className="text-base sm:text-lg text-slate-600 max-w-xl mx-auto leading-relaxed">
          SpamGuard is an AI-powered email detection system that analyzes email content and identifies whether it is Spam or Not Spam.
        </p>
      </section>
      ...
      <section>
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600 text-sm mt-1 max-w-xl mx-auto">
            Get real-time protection against phishing and malicious spam in 3 fast steps.
          </p>
        </div>
